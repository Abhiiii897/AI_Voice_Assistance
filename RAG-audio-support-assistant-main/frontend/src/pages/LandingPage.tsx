...
//TODO: MAKE AN ACTUAL ONE
//starting development on the landing page structure
...
function LandingPage() {
 ...
 const mockAgent: AgentProfile = {
  ...
  //an array of mock call logs
  /*In Production: This would come from:
  1.An API call (e.g., fetch('/api/call-logs')) or
  2. A global state management store (like Zustand, Redux, etc.)
  3. A backend WebSocket stream for real-time updates. */
  const mockCallLogs = [ 
    {
      id: '1',
  ...
  const handleStartRecording = () => {
    //TODO: Initialize mic capture & websocket logic (once backend is build)
    const store = useDashboardStore.getState();
    store.startCall();  // Sets callStartTime, activeCallId, etc.
    navigate('/call')
  };
  return (
   ...
   <div className="min-h-screen bg-gradient-to-br from-black via-neutral-950 to-neutral-900 text-white">
      ...
      <div className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        ...
        {/* Right: Agent Profile Badge (placeholder) */}
      ...
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] p-8">
        ...
        <div className="text-center max-w-2xl mb-12">
          ...
          {/* Start Recording Button (POC - simulates accepting call) */}
          <button
      ...
      <div className="bg-gray-900/80 border-t border-gray-800 px-8 py-6">
        ...
        <div className="space-y-2">
          ...
          {/* the .map() method loops through the mockcalllogs Array to 
          transform each element into a react component w the below structure*/}
